				...
				<div class="col-md-8">
					<div class="listing-single">
						...
						<?php if ( class_exists('Featured_Video_Plus') ) : ?>
                            <div class="listing-single__img-hero8 lazy bg-scroll">
								<?php the_post_thumbnail(); ?>
                            </div>
						<?php else: ?>
							<?php if ( !empty($headerImg) ) :?>
                                <div class="listing-single__img-hero8 lazy bg-scroll" data-src="<?php echo esc_url($headerImg); ?>">
